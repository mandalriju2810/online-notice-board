...
try {
  ...
  $mail->Password   = 'souvlfynxiwrkndo';                               //SMTP password
...
else
{
          ...
          $ins="INSERT INTO notice (student_year,student_date,student_subject,student_description) 
          VALUES ('$year','$date','$subject','$des') ";
          mysqli_query($con,$ins);
         ////
