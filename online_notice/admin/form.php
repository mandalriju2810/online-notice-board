      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1" ><!--form border-->
        ...
        <p><input type="password" name="password" required > </p>
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            <input type="submit" class="btn btn-primary btn-block mb-4" id="btn" name="login" value="login" >
            <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="admin_signup.php"
